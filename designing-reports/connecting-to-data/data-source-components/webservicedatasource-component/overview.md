...
|Body|The body of the login HTTP request. Applicable only for POST HTTP request method. Needed for some authentication schemes such as OAuth 2.0 Password Grant.                 Example: *grant_type=password&username=user@example.com&password=12345* |
